...
function changeRank(details, type) {
    ...
    //     let temp = getParameterByName("rankOrder");
    //     search_params.set("rankOrder", "");
    // }
    // if (details === "rankOrder") {
    //     let temp = getParameterByName("titleOrder");
...
function handleGuidedSearchResult(resultData) {
    console.log("handleGuidedSearchResult: populating star table from resultData!!");
    let movieTableBodyElement = jQuery("#guided_search_table_body");
...
let movieLetter = getParameterByName('movie');
...
jQuery.ajax({
    ...
    url: "api/guidedSearch?genre=" + genres + "&movie=" + movieLetter + "&pageNum=" + pageNum + "&results=" + results
        + '&titleOrder=' + titleOrder + '&rankOrder=' + rankOrder,
    success: (resultData) => handleGuidedSearchResult(resultData) //
});
